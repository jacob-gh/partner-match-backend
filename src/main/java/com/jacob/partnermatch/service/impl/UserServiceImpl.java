...
import com.jacob.partnermatch.common.AlgorithmUtils;
...
import com.jacob.partnermatch.mapper.UserMapper;
...
import static com.jacob.partnermatch.contant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     */
    @Override
    public List<User> searchUserByTagsBySql(List<String> tags) {
        if (CollectionUtils.isEmpty(tags)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
     ...
     */
    @Override
    public Integer upadeteUser(User user, HttpServletRequest request) {
        if (user == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        //校验权限
        ...
        if (!isAdmin(userLogin) && user.getId() != userLogin.getId()) {
